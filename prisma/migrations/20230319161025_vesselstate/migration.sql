/*
  ...
  - You are about to drop the column `vesselStateId` on the `VesselSubState` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "VesselSubState" DROP CONSTRAINT "VesselSubState_vesselStateId_fkey";

-- DropIndex
DROP INDEX "VesselSubState_vesselStateId_name_key";

-- AlterTable
ALTER TABLE "VesselSubState" DROP COLUMN "vesselStateId",
